...
public class toplamaislemActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_toplamaislem);
        islemTurleri=new ArrayList<>();
        rndIslem=new Random();
        rndSayi=new Random();
        txtSorut=(TextView)findViewById(R.id.txtSoruT);
        editTxtTahmin=(EditText)findViewById(R.id.editTxtTahminT);
        btn1=(ToggleButton) findViewById(R.id.toggleBtnT);
        btn1.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                if (b) {
                    ...
                    islemTurleri.remove("+");
                Intent kendime=new Intent(toplamaislemActivity.this,kendineGuvenActivity.class);
    ...
    public void btnClickF(View v)
    {
        switch (v.getId())
        {
            case R.id.btnSoruGetirT:
                txtSorut.setText(İslemTurunuVeSoruyuBelirle());
                break;
            case R.id.btnTahmindeBulunT:
