...
public class cikarmaislemoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cikarmaislemo);
        islemTurleri=new ArrayList<>();
        rndIslem=new Random();
        rndSayi=new Random();
        txtSoru=(TextView)findViewById(R.id.txtSoruFo);
        editTxtTahmin=(EditText)findViewById(R.id.editTxtTahminFo);
        btn1=(ToggleButton) findViewById(R.id.toggleBtnFo);
        ...
        btn1.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                ...
                {
                    islemTurleri.remove("-");
                    Intent kendime=new Intent(cikarmaislemoActivity.this,kendineGuvenActivity.class);
    ...
    public void btnClickS(View v)
    {
        switch (v.getId())
        {
            case R.id.btnSoruGetirFo:
                txtSoru.setText(İslemTurunuVeSoruyuBelirle());
                break;
            case R.id.btnTahmindeBulunFo:
                TahminKontrol();
                break;
        }
    }
