...
public class carpmaislemoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_carpmaislemo);
        islemTurleri=new ArrayList<>();
        rndIslem=new Random();
        rndSayi=new Random();
        txtSorut=(TextView)findViewById(R.id.txtSoruCo);
        editTxtTahmin=(EditText)findViewById(R.id.editTxtTahminCo);
        btn1=(ToggleButton) findViewById(R.id.toggleBtnCo);
        ...
        btn1.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                ...
                {
                    islemTurleri.remove("*");
                    Intent kendime=new Intent(carpmaislemoActivity.this,kendineGuvenActivity.class);
    ...
    public void btnClickB(View v)
    {
        switch (v.getId())
        {
            case R.id.btnSoruGetirCo:
                txtSorut.setText(İslemTurunuVeSoruyuBelirle());
                break;
            case R.id.btnTahmindeBulunCo:
                TahminKontrol();
                break;
        }
    }
