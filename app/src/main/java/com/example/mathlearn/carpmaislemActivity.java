...
public class carpmaislemActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_carpmaislem);
        islemTurleri=new ArrayList<>();
        rndIslem=new Random();
        rndSayi=new Random();
        txtSorut=(TextView)findViewById(R.id.txtSoruC);
        editTxtTahmin=(EditText)findViewById(R.id.editTxtTahminC);
        btn1=(ToggleButton) findViewById(R.id.toggleBtnC);
        ...
        btn1.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                ...
                {
                    islemTurleri.remove("*");
                    Intent kendime=new Intent(carpmaislemActivity.this,kendineGuvenActivity.class);
    ...
    public void btnClickB(View v)
    {
        switch (v.getId())
        {
            case R.id.btnSoruGetirC:
                txtSorut.setText(İslemTurunuVeSoruyuBelirle());
                break;
            case R.id.btnTahmindeBulunC:
                TahminKontrol();
                break;
        }
    }
