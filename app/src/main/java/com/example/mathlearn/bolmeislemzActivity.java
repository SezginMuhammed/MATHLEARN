...
public class bolmeislemzActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bolmeislemz);
        islemTurleri=new ArrayList<>();
        rndIslem=new Random();
        rndSayi=new Random();
        txtSorut=(TextView)findViewById(R.id.txtSoruBz);
        editTxtTahmin=(EditText)findViewById(R.id.editTxtTahminBz);
        btn1=(ToggleButton) findViewById(R.id.toggleBtnBz);
        ...
        btn1.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                ...
                {
                    islemTurleri.remove("/");
                    Intent kendime=new Intent(bolmeislemzActivity.this,kendineGuvenActivity.class);
    ...
    public void btnClickC(View v)
    {
        switch (v.getId())
        {
            case R.id.btnSoruGetirBz:
                txtSorut.setText(İslemTurunuVeSoruyuBelirle());
                break;
            case R.id.btnTahmindeBulunBz:
                TahminKontrol();
                break;
        }
    }
