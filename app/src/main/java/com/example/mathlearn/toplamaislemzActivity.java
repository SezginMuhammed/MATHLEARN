...
public class toplamaislemzActivity extends AppCompatActivity {
    ...
    private int s1,s2,s3,sonuc;
    private ToggleButton btn1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_toplamaislemz);
        islemTurleri=new ArrayList<>();
        rndIslem=new Random();
        rndSayi=new Random();
        txtSoru=(TextView)findViewById(R.id.txtSoruTz);
        editTxtTahmin=(EditText)findViewById(R.id.editTxtTahminTz);
        btn1=(ToggleButton) findViewById(R.id.toggleBtnTz);
        ...
        btn1.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                if (b) {
                    ...
                    islemTurleri.remove("+");
                    Intent kendime = new Intent(toplamaislemzActivity.this, kendineGuvenActivity.class);
    ...
    public void btnClickF(View v)
    {
        switch (v.getId())
        {
            case R.id.btnSoruGetirTz:
                txtSoru.setText(İslemTurunuVeSoruyuBelirle());
                break;
            case R.id.btnTahmindeBulunTz:
                TahminKontrol();
                break;
        }
    }
